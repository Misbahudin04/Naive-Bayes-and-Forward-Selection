...
#print(fsig.head(5))
UF = uf.UjiF(urutanlist,rsquare,features,labels,fsig,dc)
UFF = UF.fhitung()
...
#train8 = cvv.latihh8()
#train9 = cvv.latihh9()
#train10 = cvv.latihh10()



'''========= NAIVE BAYES ============='''
datasetuji = dataset.iloc[0:17]
dataset_uji = datasetuji
dataset_latih = dataset.iloc[19:116]
datasetlatih = dataset_latih

#1
##print('====ini cetak=============')
##nb=nbb.Naivebayes(train1)
##dl = nb.latih()         #model latih
##du = nb.uji(fold1)           #predicted
#2

#print('ini',dcc)
#nb=nbb.Naivebayes(dcc)
#dl = nb.latih()         #model latih
#du = nb.uji(dcc)           #predicted

#3
#nb=nbb.Naivebayes(train3)
#dl = nb.latih()         #model latih
#du = nb.uji(fold3)           #predicted
