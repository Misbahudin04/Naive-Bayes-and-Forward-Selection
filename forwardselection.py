...
class ForwardSelection:
    ...
    def correlation(self):
        ...
        while y < len(self.dataset.columns) - 1:
            #print(y)
            korelasix = ((n*(self.__xy[self.dataset.columns[y]])-(self.__x[self.dataset.columns[y]] * self.__x[self.dataset.columns[-1]])) / ((mt.sqrt((n*((self.__xsquare[self.dataset.columns[y]]))) - ((self.__x[self.dataset.columns[y]])**2)))*(mt.sqrt((n * ((self.__xsquare[self.dataset.columns[-1]]))) - ((self.__x[self.dataset.columns[-1]]) ** 2)))))**2
